...
In order to allow SkyPoint access to your Boulevard account, you'll need:
...
## Steps to Achieve all the necessary details for your Boulevard account

1. Will be added in the next version.

## Steps to Import Data Using Boulevard
...
3. You will see all the different types of connectors present infront of you. In the search bar present on top right, type Boulevard and select the Boulevard connector.

![Alt text](https://github.com/skypointcloud/platform/blob/master/docs/doc_snippets/boulevardstep1.PNG?raw=true)
